...
empRoutes.post('/register',(req,res)=>{
        ...
        nullChecker.check(req.body.uid);     //checking for null values
        object.id=req.body.uid;
        nullChecker.check(req.body.name);
        object.name=req.body.name;
        nullChecker.check(req.body.password);
        ...
        nullChecker.check(req.body.mobile_no);
        ...
        nullChecker.check(req.body.date_of_birth);
        object.date_of_birth=req.body.date_of_birth;    
        nullChecker.check(req.body.typeEmployee);        //filling data into object to be given to db
